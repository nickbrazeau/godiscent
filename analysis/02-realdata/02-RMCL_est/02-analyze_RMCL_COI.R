...
#...........................................................
# drc provs
DRCprov <- sf::st_as_sf(readRDS("data/derived_data/map_bases/gadm/gadm36_COD_1_sp.rds"))
drccites <- readr::read_csv("data/derived_data/map_bases/DRC_city_coordinates.csv") %>%
...
ggplot() +
  ...
  theme_minimal() +
  coord_sf(datum = NA) +
  ggtitle("Jitter Cluster COI Counts")
...
pfincidence_plotObj <- ggplot() +
  ggspatial::layer_spatial(data = pfincidence, aes(fill = after_stat(band1))) +
